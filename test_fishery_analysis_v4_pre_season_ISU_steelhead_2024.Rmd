...
colors <- c("PSF_update" = "red","PSF"= "blue")
ggplot(x,aes(x=year,y=trs))+
  ...
  geom_point()+ 
  geom_ribbon(mapping = aes(x=year,ymin =`2.5%`, ymax = `97.5%`),alpha=0.25,fill="blue")+
  geom_ribbon(mapping = aes(x=year,ymin =`25%`, ymax = `75%`),alpha=0.25,fill="blue")+
  geom_line(mapping=aes(x=year,y=`50%`,color = "PSF"))+
  geom_line(mapping=aes(x=year,y=`50%`),color = "blue")+
  geom_point()+
