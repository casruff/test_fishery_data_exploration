...
catch ~ negative binomial ( exp(intercept + factor(site) + factor(set number) + random walk (day of year) + log(effort in seconds) + log(centered year effect), over-dispersion parameter) 
